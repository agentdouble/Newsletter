...
- **Collect** : formulaire minimaliste noir & blanc pour que les utilisateurs envoient leurs success/fail stories, avec saisie du nom (ou équipe) pour identifier la contribution.
...
- **Générateur** : vue admin qui consomme les contributions et génère un texte complet de newsletter, immédiatement poussé dans le fil, avec une surface d’édition simple en noir et blanc (typographie identique à la lecture). Les actions « Générer un draft » et « Publier dans le fil » sont positionnées sous la zone d’édition pour ne pas masquer le contenu, et la liste des contributions est consultable dans l’onglet dédié « Contributions ».
