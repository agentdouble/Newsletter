...
- **Collect** : formulaire minimaliste noir & blanc avec trois blocs (faits marquants, success story, fail story) pour guider les contributions, avec des champs encore plus compacts (une seule vue sans scroll) et des exemples contextualisés aux services d’assurance.
